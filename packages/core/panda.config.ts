    ...
    semanticTokens: {
      colors: {
        ...
        accent: {
          ...
          subtle: { value: { base: '{colors.emerald.50}', _dark: '{colors.emerald.900}/20' } },
        ...
        warning: {
          ...
          subtle: { value: { base: '{colors.amber.50}', _dark: '{colors.amber.900}/20' } },
          fg: { value: { base: '{colors.white}', _dark: '{colors.gray.950}' } },
        },
        error: {
          DEFAULT: { value: { base: '{colors.red.500}', _dark: '{colors.red.400}' } },
          subtle: { value: { base: '{colors.red.50}', _dark: '{colors.red.900}/20' } },
          fg: { value: { base: '{colors.white}', _dark: '{colors.white}' } },
        },
        info: {
          DEFAULT: { value: { base: '{colors.blue.500}', _dark: '{colors.blue.400}' } },
          subtle: { value: { base: '{colors.blue.50}', _dark: '{colors.blue.900}/20' } },
          fg: { value: { base: '{colors.white}', _dark: '{colors.white}' } },
        },
      },
    },
