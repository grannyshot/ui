  ...
  theme: {
    ...
    semanticTokens: {
      colors: {
        ...
        ring: {
          DEFAULT: { value: { base: '{colors.emerald.500}', _dark: '{colors.emerald.400}' } },
        },
        overlay: {
          DEFAULT: { value: { base: 'rgba(0, 0, 0, 0.5)', _dark: 'rgba(0, 0, 0, 0.7)' } },
        },
        accent: {
          ...
          subtle: { value: { base: '{colors.emerald.50}', _dark: 'color-mix(in srgb, {colors.emerald.900} 20%, transparent)' } },
        ...
        warning: {
          ...
          subtle: { value: { base: '{colors.amber.50}', _dark: 'color-mix(in srgb, {colors.amber.900} 20%, transparent)' } },
          fg: { value: { base: '{colors.white}', _dark: '{colors.gray.950}' } },
        },
        error: {
          DEFAULT: { value: { base: '{colors.red.500}', _dark: '{colors.red.400}' } },
          subtle: { value: { base: '{colors.red.50}', _dark: 'color-mix(in srgb, {colors.red.900} 20%, transparent)' } },
          fg: { value: { base: '{colors.white}', _dark: '{colors.white}' } },
        },
        info: {
          DEFAULT: { value: { base: '{colors.blue.500}', _dark: '{colors.blue.400}' } },
          subtle: { value: { base: '{colors.blue.50}', _dark: 'color-mix(in srgb, {colors.blue.900} 20%, transparent)' } },
          fg: { value: { base: '{colors.white}', _dark: '{colors.white}' } },
        },
      },
    },
