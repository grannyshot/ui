...
export const datePickerInput = 'w-full border border-gs-border rounded-md pl-3 pr-3 h-9 text-sm bg-gs-bg text-gs-fg outline-none transition-[border-color] duration-150 ease-in-out focus:border-gs-border-focus data-[disabled]:opacity-50 data-[disabled]:cursor-not-allowed placeholder:text-gs-fg-subtle'
...
export const datePickerViewTrigger = 'text-sm font-semibold text-gs-fg cursor-pointer bg-transparent border-none rounded-md pl-2 pr-2 py-1 transition-[background] duration-100 ease-in-out hover:bg-gs-bg-muted'
